...
1. Read and understand all rules in CLAUDE.md
2. Review PROJECT_MEMORY.md to understand current project status
3. Check DEVELOPMENT_TRACKING.md to confirm development progress
4. Reference QUICK_REFERENCE.md for necessary information
